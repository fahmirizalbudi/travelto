        ...
        <div className="max-w-7xl mx-auto">
          {isLoading ? (
            ...
            <div className="text-center py-20">
              ...
              <Link
                href="/packages"
                className="inline-block bg-cta text-white hover:bg-cta/90 px-8 py-4 rounded-2xl font-medium transition-colors"
              >
                Explore Packages
              </Link>
            </div>
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-4 mt-auto pt-4">
                        ...
                        {order.status === "pending" && (
                          <button
                            ...
                            className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-red-50 text-red-600 hover:bg-red-100 font-medium transition-colors disabled:opacity-50"
                          >
