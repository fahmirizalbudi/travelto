...
export function HeroSection() {
  return (
    <section className="relative min-h-[calc(100vh-88px)] py-12 px-6 max-w-7xl mx-auto flex items-center justify-center w-full">
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 w-full">
        ...
        <div className="w-full lg:w-[55%] flex flex-col justify-center relative z-10">
          ...
          {/* Flat Search01Icon Bar embedded below text */}
        ...
        <div className="w-full lg:w-[45%] relative mt-16 lg:mt-0 flex items-center justify-center">
          <div className="flex gap-6 w-full items-center justify-center">
            ...
            <div className="flex flex-col w-1/2 relative mt-12">
              ...
              <Link href="/packages" className="bg-[#2F6EEA] rounded-[2.5rem] h-[380px] md:h-[440px] w-full flex flex-col justify-end p-6 z-10 transform translate-y-4 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300  cursor-pointer">
                <div className="absolute inset-0 w-full h-full group-hover:scale-105 transition-transform duration-700" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1499856871958-5b9627545d1a?auto=format&fit=crop&q=80&w=800")', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
                <div className="bg-white/90 backdrop-blur-sm rounded-[1.5rem] px-5 py-3 w-fit flex flex-col gap-1 items-start  relative z-10 group-hover:bg-white transition-colors">
                  <span className="text-cta text-[13px] font-semibold leading-none">Best</span>
                  <span className="text-cta text-[14px] font-bold leading-none pb-0.5 group-hover:text-orange-600">Packages</span>
                </div>
              </Link>
            </div>
